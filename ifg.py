...
def baliho():
	try:
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('I F G').center(44)
		print (W + '      [' + G +'Information Facebook Gathering'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'IFG' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
